...
export interface ApiAnalysisRequestAnalysisRequest
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::analysis-request.analysis-request'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['block.introduction', 'block.content-section', 'ui.divider']
    > &
    ...
    display_table_of_contents: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    table_of_contents_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'I den h\u00E4r artikeln'>;
...
export interface ApiBuildProjectPageBuildProjectPage
...
export interface ApiProjectRequestProjectRequest
  ...
  attributes: {
    appending: Schema.Attribute.Enumeration<['new', 'reviewed', 'archived']> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::analysis-request.analysis-request': ApiAnalysisRequestAnalysisRequest;
      'api::article.article': ApiArticleArticle;
      'api::articles-page.articles-page': ApiArticlesPageArticlesPage;
      'api::build-project-page.build-project-page': ApiBuildProjectPageBuildProjectPage;
