...
<template>
	<div
		...
		<ol class="relative flex justify-between">
			<li v-for="(step, i) in steps" :key="step.id" class="flex flex-col items-center text-center w-full mb-lg">
				<div
					...
					<span class="text-xs md:text-sm lg:text-md font-semibold">{{ i + 1 }}</span>
				</div>
